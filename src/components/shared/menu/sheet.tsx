...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Overlay
    className={cn(
      "fixed inset-0 data-[state=open]:z-50 z-20 border-[16px] border-gray-500 data-[state=closed]:animate-out delay-300 after:absolute after:-top-[20px] after:-left-[20px] after:rounded-lg after:h-full after:w-full",
      className
    )}
    {...props}
    ref={ref}
