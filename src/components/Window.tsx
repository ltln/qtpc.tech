...
export default function Window() {
    ...
    return (
        <Draggable handle=".handle">
            <div className={cx(!state ? "hidden" : "visible","h-[500px] w-[900px] bg-white border-4 border-black")}>
                    ...
                    <div className="w-full handle cursor-move">
                        ...
                        <div className="absolute bg-white p-1 top-[2px] left-4 cursor-default">
                            <div className="h-6 w-6 border-2 border-black" onClick={() => timeout()}>
                                <Image src={Close} alt="" className={cx(state != "load" ? "hidden" : "visible", "bg-black")} />
                            </div>
                        </div>
                    </div>
